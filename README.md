# Крючихин Олег — Python-разработчик

## О себе

Привет! Я Python-разработчик — строю приложения и API, пишу бизнес-логику, оптимизирую код. Люблю работать с базами данных и искать способы сделать всё побыстрее.
